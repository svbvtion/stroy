module.exports = () => {
	$.gulp.task('watch', () => {
		...
		$.gulp.watch(['src/static/img/**/*.jpg', '!src/static/img/responsive/**/*.*'], $.gulp.series('mozjpeg'))
		$.gulp.watch(['src/static/img/**/*.png', '!src/static/img/responsive/**/*.*'], $.gulp.series('pngquant'))
